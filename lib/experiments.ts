...
export const experiments: Experiment[] = [
  ...
  },
  {
    ...
    descriptionAr: 'حدد اللون الذي يراه الشخص في توليفات مختلفة للضوء من الألوان الحمراءوالخضراء والزرقاء. صف لون الضوء الذي يمكنه النفاذ عبر عبر مجموعة مختلفة من الفلاتر الملونة.',
    descriptionEn: 'Determine what color the person sees for various combinations of red, green, and blue light. Describe the color of light that is able to pass through different colored filters.',
    category: 'biology',
    iframe: 'https://phet.colorado.edu/sims/html/color-vision/latest/color-vision_ar_SA.html',
    width: '100%',
    height: '600px',
    icon: '💨',
  },
